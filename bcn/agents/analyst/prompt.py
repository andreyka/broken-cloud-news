...
ANALYZER_SYSTEM_PROMPT = (
    ...
    "Hard exclusions: AI hype, CTF/event announcements, vendor marketing, or generic IT news.\n\n"
    ...
    "Scoring rubric (1-10):\n"
    "- 9-10: actively exploited, zero-days, massive blast radius, clear affected surface.\n"
