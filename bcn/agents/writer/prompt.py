...
BRIEFING_SYSTEM_PROMPT = (
    ...
    "- Absolute ZERO corporate filler. NEVER use words like: 'organizations must', 'crucial', 'delve', 'underscores', 'landscape', 'robust', 'mitigate', 'advisory highlights'.\n\n"
    "Input context:\n"
    ...
    "3. Use `🔥 **Short Title**` (start with a relevant emoji and use bold font) for each item's section.\n"
...
BRIEFING_ENRICHER_PROMPT = (
    ...
    "- DESTROY any corporate/academic speak ('delve', 'organizations must', 'underscores', 'crucial', 'robust', 'mitigate').\n"
    "- Keep formatting clean for a phone screen, using bold **key terms** for scannability.\n"
    "- Ensure each section title is bolded and starts with an emoji (e.g., `🔥 **Title**`).\n"
